...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Modifying
    @Query("update RoomRequest rr set rr.room = null, rr.status = 'AWAITING' where rr.status = 'AWAITING_CONFIRMATION' and rr.room.id = :roomId and (:checkInDate <= rr.checkOutDate and :checkOutDate >= rr.checkInDate)")
    void unAssignRoomOnOverlappingDates(Long roomId,LocalDate checkInDate, LocalDate checkOutDate);
